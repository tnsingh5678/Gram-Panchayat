...
export default function AdminLogin(){
    ...
    return(
        ...
        <div className="flex object-fill justify-between">
            ...
            <img src="https://media.geeksforgeeks.org/wp-content/uploads/20230222104738/file.png" className="w-[100px] h-[100px] rounded-full"></img></div>
        ...
        <div>
            ...
            <button className="p-2 m-4 bg-gray-400 border-2 rounded-full border-indigo-600" onClick={(e)=>e.preventDefault()}>Forgot Password?</button>
            <Link to="/admin/register" className="p-2 m-4 bg-gray-400 border-2 rounded-full border-indigo-600">Register</Link>
